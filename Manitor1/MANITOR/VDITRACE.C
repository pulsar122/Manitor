...
VDIFUNC vdi_func[] = {
	...
	{5, 39, EGAL, EGAL, "vq_prn_scaling", 1, {{CONTRL, 6, T_INT, "hnd"}}, 1, {{INTOUT, 0, T_FIX31, "ret"}}, OUT_NONE, FALSE},
	{5, 60, EGAL, EGAL, "vs_palette", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "palette"}}, 1, {{INTOUT, 0, T_INT, "ret"}}, OUT_NONE, FALSE},
	{5, 61, EGAL, EGAL, "v_sound", 3, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "frequency"}, {INTIN, 1, T_INT, "duration"}}, 0, {0}, OUT_NONE, FALSE},
	{5, 62, EGAL, EGAL, "vs_mute", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "action"}}, 1, {{INTOUT, 0, T_INT, "ret"}}, OUT_NONE, FALSE},
	{5, 76, EGAL, EGAL, "vs_calibrate", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 2, T_INT, "flag"}}, 1, {{INTOUT, 0, T_INT, "ret"}}, OUT_NONE, FALSE},
	{5, 77, EGAL, EGAL, "vq_calibrate", 1, {{CONTRL, 6, T_INT, "hnd"}}, 1, {{CONTRL, 4, T_INT, "ret"}}, OUT_NONE, FALSE},
	{5, 81, EGAL, EGAL, "vt_resolution", 0, {0}, 0, {0}, OUT_NONE, FALSE}, /* Graphics tablet functions */
	{5, 82, EGAL, EGAL, "vt_axis", 0, {0}, 0, {0}, OUT_NONE, FALSE},       /* Graphics tablet functions */
	{5, 83, EGAL, EGAL, "vt_origin", 0, {0}, 0, {0}, OUT_NONE, FALSE},     /* Graphics tablet functions */
	{5, 84, EGAL, EGAL, "vq_tdimensions", 0, {0}, 0, {0}, OUT_NONE, FALSE},/* Graphics tablet functions */
	{5, 85, EGAL, EGAL, "vt_alignment", 0, {0}, 0, {0}, OUT_NONE, FALSE},  /* Graphics tablet functions */
	{5, 91, EGAL, EGAL, "vsp_film", 0, {0}, 0, {0}, OUT_NONE, FALSE},      /* Polaroid functions        */
	{5, 92, EGAL, EGAL, "vqp_filmname", 0, {0}, 0, {0}, OUT_NONE, FALSE},  /* Polaroid functions        */
	{5, 93, EGAL, EGAL, "vsc_expose", 0, {0}, 0, {0}, OUT_NONE, FALSE},    /* Polaroid functions        */
	{5, 94, EGAL, EGAL, "vsp_save", 0, {0}, 0, {0}, OUT_NONE, FALSE},      /* Polaroid functions        */
	{5, 95, EGAL, EGAL, "vsp_message", 0, {0}, 0, {0}, OUT_NONE, FALSE},   /* Polaroid functions        */
	{5, 96, EGAL, EGAL, "vqp_error", 0, {0}, 0, {0}, OUT_NONE, FALSE},     /* Polaroid functions        */
	...
	{5, 101, EGAL, EGAL, "v_offset", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "offset"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{5, 2100, EGAL, EGAL, "vq_margins", 1, {{CONTRL, 6, T_INT, "hnd"}}, 7, {{INTOUT, 0, T_INT, "ret"}, {INTOUT, 1, T_INT, "top_margin"}, {INTOUT, 2, T_INT, "bottom_margin"}, {INTOUT, 3, T_INT, "left_margin"},
                                           {INTOUT, 4, T_INT, "right_margin"}, {INTOUT, 5, T_INT, "hdpi"}, {INTOUT, 6, T_INT, "vdpi"}}, OUT_NONE, FALSE},
	{5, 2103, EGAL, EGAL, "vs_document_info", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "type"}, {INTIN, 0, T_INT, "type"}}, 1, {{INTOUT, 0, T_INT, "ret"}}, OUT_NONE, FALSE},
	...
	{9, 13, EGAL, EGAL, "v_bez_fill", 3, {{CONTRL, 6, T_INT, "hnd"}, {CONTRL, 1, T_INT, "count"}, {VDIPBIN, 0, T_V_BEZ, 0L}}, 6, {{INTOUT, 0, T_INT, "jumps"}, {INTOUT, 1, T_INT, "pts"},
												{PTSOUT, 0, T_INT, "x1"}, {PTSOUT, 1, T_INT, "y1"}, {PTSOUT, 2, T_INT, "x2"}, {PTSOUT, 3, T_INT, "y2"}}, OUT_NONE, FALSE},
	{10, NO_SUBCODE, EGAL, EGAL, "v_cellarray", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{11, 10, EGAL, EGAL, "v_justified", 7, {{CONTRL, 6, T_INT, "hnd"}, {PTSIN, 0, T_INT, "x"}, {PTSIN, 1, T_INT, "y"}, {PTSIN, 2, T_INT, "width"}, {INTIN, 0, T_INT, "word_space"}, {INTIN, 1, T_INT, "char_space"},
														{VDIPBIN, 0, T_VDISTR, "\2""txt"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{29, NO_SUBCODE, EGAL, EGAL, "vrq/vsm_valuator", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE}, /* ??? */
	{30, NO_SUBCODE, EGAL, EGAL, "vrq/vsm_choice", 1, {{CONTRL, 6, T_INT, "hnd"}}, 1, {{INTOUT, 0, T_INT, "choice"}}, OUT_NONE, FALSE},
	{31, NO_SUBCODE, EGAL, EGAL, "vrq/vsm_string", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},		/* ??? */
	...
	{38, NO_SUBCODE, EGAL, EGAL, "vqt_attributes", 1, {{CONTRL, 6, T_INT, "hnd"}}, 10, {{INTOUT, 0, T_INT, "attrib[0]"}, {INTOUT, 1, T_INT, "attrib[1]"}, {INTOUT, 2, T_INT, "attrib[2]"}, {INTOUT, 3, T_INT, "attrib[3]"},
                                                      {INTOUT, 4, T_INT, "attrib[4]"}, {INTOUT, 5, T_INT, "attrib[5]"}, {PTSOUT, 0, T_INT, "attrib[6]"}, {PTSOUT, 1, T_INT, "attrib[7]"}, {PTSOUT, 2, T_INT, "attrib[8]"}, {PTSOUT, 3, T_INT, "attrib[9]"}}, OUT_NONE, FALSE},
	...
	{100, 2, EGAL, EGAL, "v_resize_bm", 4, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "width"}, {INTIN, 1, T_INT, "height"}, {INTIN, 2, T_LONG, "byte_width"}}, 1, {{INTOUT, 0, T_INT, "hor"}}, OUT_NONE, FALSE},
	{100, 3, EGAL, EGAL, "v_open_bm", 1, {{CONTRL, 6, T_INT, "base_handle"}}, 1, {{CONTRL, 6, T_INT, "handle"}}, OUT_NONE, FALSE},
	...
	{102, 0, EGAL, EGAL, "vq_extnd", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "owflag"}}, 0, {0}, OUT_NONE, FALSE},
	{102, 1, EGAL, EGAL, "vq_scrninfo", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{110, NO_SUBCODE, EGAL, EGAL, "vr_trnfm", 3, {{CONTRL, 6, T_INT, "hnd"}, {CONTRL, 7, T_MFDB, "psrcMFDB"}, {CONTRL, 9, T_MFDB, "pdesMFDB"}}, 0, {0}, OUT_NONE, FALSE},
	{111, NO_SUBCODE, EGAL, EGAL, "vsc_form", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{117, NO_SUBCODE, EGAL, EGAL, "vqt_width", 1, {{CONTRL, 6, T_INT, "hnd"}}, 1, {{INTOUT, 0, T_INT, "Return"}}, OUT_NONE, FALSE},
	{118, NO_SUBCODE, EGAL, EGAL, "vex_timv", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{121, NO_SUBCODE, EGAL, EGAL, "vrt_cpyfm", 7, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "mode"}, {CONTRL, 7, T_MFDB, "psrcMFDB"},
	                                                {CONTRL, 9, T_MFDB, "pdesMFDB"}, {VDIPBIN, 0, T_V_PLINE, "xy"}, {INTIN, 1, T_INT, "ColorIndex[0]"}, {INTIN, 2, T_INT, "ColorIndex[1]"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{125, NO_SUBCODE, EGAL, EGAL, "vex_butv", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	{126, NO_SUBCODE, EGAL, EGAL, "vex_motv", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	{127, NO_SUBCODE, EGAL, EGAL, "vex_curv", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	{128, NO_SUBCODE, EGAL, EGAL, "vq_key_s", 1, {{CONTRL, 6, T_INT, "hnd"}}, 1, {{INTOUT, 0, T_INT, "pstatus"}}, OUT_NONE, FALSE},
	...
	{130, 0, EGAL, EGAL, "vqt_name", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "element_num"}}, 1,  {{INTOUT, 0, T_INT, "index"}}, OUT_NONE, FALSE},
	{130, 1, EGAL, EGAL, "vqt_ext_name", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "index"}}, 3,  {{INTOUT, 0, T_INT, "index"}, {INTOUT, 33, T_INT, "Flag [32]"}, {INTOUT, 34, /*T_VQT_EXT_NAME*/ T_INT_HEX, "flags/font_format"}}, OUT_NONE, FALSE},
	{131, NO_SUBCODE, EGAL, EGAL, "vqt_fontinfo", 1, {{CONTRL, 6, T_INT, "hnd"}}, 11, { {INTOUT, 0, T_INT, "minADE"}, {INTOUT, 1, T_INT, "maxADE"},
                                     {PTSOUT, 0, T_INT, "max_width"}, {PTSOUT, 1, T_INT, "distances[0]"}, {PTSOUT, 3, T_INT, "distances[1]"},
                                     {PTSOUT, 5, T_INT, "distances[2]"}, {PTSOUT, 7, T_INT, "distances[3]"}, {PTSOUT, 9, T_INT, "distances[4]"},
                                     {PTSOUT, 2, T_INT, "effects[0]"}, {PTSOUT, 4, T_INT, "effects[1]"}, {PTSOUT, 6, T_INT, "effects[2]"}
                                     }, OUT_NONE, FALSE},
	{132, NO_SUBCODE, EGAL, EGAL, "vqt_justified", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{171, 1, EGAL, EGAL, "vr_clip_rects_by_src", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	{171, 2, EGAL, EGAL, "vr_clip_rects32_by_dst", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	{171, 3, EGAL, EGAL, "vr_clip_rects32_by_src", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},

	{180, NO_SUBCODE, EGAL, EGAL, "v_create_driver_info", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "driver_id"}}, 0, {0}, OUT_NONE, FALSE},
	{181, NO_SUBCODE, EGAL, EGAL, "v_delete_driver_info", 1, {{CONTRL, 6, T_INT, "hnd"}}, 1, {{INTOUT, 0, T_INT, "ret"}}, OUT_NONE, FALSE},
	{182, 0, EGAL, EGAL, "v_read_default_settings", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	{182, 1, EGAL, EGAL, "v_write_default_settings", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},

	{190, NO_SUBCODE, EGAL, EGAL, "vqt_char_index", 1, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "scr_index"}, {INTIN, 1, T_INT, "src_mode"}, {INTIN, 2, T_INT, "dst_mode"}}, 1, {{INTOUT, 0, T_INT_HEX, "Index"}}, OUT_NONE, FALSE},
	...
	{229, NO_SUBCODE, EGAL, EGAL, "vqt_xfntinfo", 4, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT_HEX, "flags"}, {INTIN, 1, T_INT, "id"}, {INTIN, 2, T_INT, "index"}}, 0, {0}, OUT_NONE, FALSE},

	{230, 0, EGAL, EGAL, "vst_name", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "font_format"}}, 1, {{INTOUT, 0, T_INT, "ID"}}, OUT_NONE, FALSE},
	...
	{236, NO_SUBCODE, 1, EGAL, "vst_charmap", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "mode"}}, 0, {0}, OUT_NONE, FALSE},
	{236, NO_SUBCODE, 2, EGAL, "vst_map_mode", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "mode"}}, 1, {{INTOUT, 0, T_INT, "mode"}}, OUT_NONE, FALSE},
	{237, NO_SUBCODE, 3, EGAL, "vst_kern", 3, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "tmode"}, {INTIN, 2, T_INT, "pmode"}}, 2, {{INTOUT, 0, T_INT, "tracks"}, {INTOUT, 1, T_INT, "pairs"}}, OUT_NONE, FALSE},
	{237, NO_SUBCODE, 4, EGAL, "vst_track_offset", 0, {0}, 2, {{INTOUT, 0, T_INT, "tracks"}, {INTOUT, 1, T_INT, "pairs"}}, OUT_NONE, FALSE},
	{239, NO_SUBCODE, EGAL, EGAL, "v_getbitmap_info", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "ch"}}, 0, {0}, OUT_NONE, FALSE},
	...
	{246, NO_SUBCODE, EGAL, EGAL, "vst_arbpt32", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_FIX31, "point"}}, 4, {{PTSOUT, 0, T_INT, "chwd"}, {PTSOUT, 1, T_INT, "chht"}, {PTSOUT, 2, T_INT, "cellwe"}, {PTSOUT, 3, T_INT, "cellht"}}, OUT_NONE, FALSE},
	{245, NO_SUBCODE, EGAL, EGAL, "vst_error", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "mode"}}, 0, {0}, OUT_NONE, FALSE},
	{247, NO_SUBCODE, EGAL, EGAL, "vqt_advance32", 0, {0}, 0, {0}, OUT_NONE, FALSE},
	{248, 0, EGAL, EGAL, "vq_devinfo", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "device"}}, 0, {0}, OUT_NONE, FALSE},
	{248, 4242, EGAL, EGAL, "vq_ext_devinfo", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "device"}}, 2, {{INTOUT, 1, T_INT, "ret"}, {INTOUT, 0, T_INT, "dev_exists"}}, OUT_NONE, FALSE},

	{250, NO_SUBCODE, EGAL, EGAL, "v_loadcache", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "mode"}}, 1, {{INTOUT, 0, T_INT, "ret"}}, OUT_NONE, FALSE},
	{251, NO_SUBCODE, EGAL, EGAL, "v_flushcache", 1, {{CONTRL, 6, T_INT, "hnd"}}, 1, {{INTOUT, 0, T_INT, "ret"}}, OUT_NONE, FALSE},
	{252, NO_SUBCODE, EGAL, EGAL, "vst_setsize32", 0, {0}, 0, {0}, OUT_NONE, FALSE},
	{253, NO_SUBCODE, EGAL, EGAL, "vst_skew", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "skew"}}, 1, {{INTOUT, 0, T_INT, "ret skew"}}, OUT_NONE, FALSE},
	{254, NO_SUBCODE, EGAL, EGAL, "vqt_get_table", 1, {{CONTRL, 6, T_INT, "hnd"}}, 0, {0}, OUT_NONE, FALSE},
	{255, NO_SUBCODE, EGAL, EGAL, "vqt_cachesize", 2, {{CONTRL, 6, T_INT, "hnd"}, {INTIN, 0, T_INT, "which_cache"}}, 1, {{INTOUT, 0, T_LONG, "size"}}, OUT_NONE, FALSE},
